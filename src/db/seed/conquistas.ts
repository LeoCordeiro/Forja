    ...
    dias: [
      {
        ...
        cor: '#FF5A1F',
        exercicios: [
          ['Supino reto com barra', 4, 6, 10, 120],
          ['Supino inclinado com halteres', 3, 8, 12, 90],
          ['Crossover na polia', 3, 12, 15, 60],
          ['Desenvolvimento com halteres', 3, 8, 12, 90],
          ['Elevação lateral', 4, 12, 15, 45],
      ...
      },
      {
        ...
        exercicios: [
          ...
          ['Puxada frontal na polia', 3, 10, 12, 90],
          ['Remada baixa na polia', 3, 10, 12, 90],
          ['Face pull', 3, 15, 20, 45],
          ['Rosca direta com barra', 3, 8, 12, 60],
      ...
      },
      {
        ...
        exercicios: [
          ...
          ['Levantamento terra romeno', 3, 8, 12, 120],
          ['Cadeira extensora', 3, 12, 15, 60],
          ['Mesa flexora', 3, 10, 15, 60],
          ['Panturrilha em pé', 4, 12, 20, 45],
          ['Prancha', 3, 0, 0, 60],
        ],
      },
    ],
    ...
    dias: [
      {
        ...
        exercicios: [
          ...
          ['Remada curvada com barra', 4, 5, 8, 150],
          ['Desenvolvimento militar', 4, 5, 8, 150],
          ['Barra fixa', 3, 6, 10, 120],
          ['Rosca direta com barra', 3, 8, 10, 60],
          ['Supino fechado', 3, 8, 10, 90],
        ],
      },
      {
        ...
        exercicios: [
          ...
          ['Afundo com halteres', 3, 10, 12, 90],
          ['Mesa flexora', 3, 10, 12, 60],
          ['Panturrilha em pé', 4, 12, 15, 45],
        ],
      },
    ],
  },
